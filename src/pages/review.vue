  ...
  <LandingContainer>
    ...
    <div class="flex flex-col gap-3 mx-auto max-w-4xl mt-16">
      ...
      <p class="text-lg leading-relaxed text-slate-500">
        Dive deep into collaborative code reviews, track progress, and provide constructive feedback to enhance the
        quality of development projects. Empower your team with detailed insights and ensure best practices are followed
        across all coding endeavors.
      </p>
