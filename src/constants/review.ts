    ...
    topics: [
      {
        ...
        questions: [
          { question: 'Are mysterious names avoided?', score: 0, comment: '' },
          { question: 'Is duplicate code avoided?', score: 0, comment: '' },
          { question: 'Are long functions avoided?', score: 0, comment: '' },
          { question: 'Are functions with a long parameter list avoided?', score: 0, comment: '' },
          { question: 'Is non-state global data avoided?', score: 0, comment: '' },
          { question: 'Is global mutable data avoided?', score: 0, comment: '' },
          { question: 'Are you able to make a change in one single point?', score: 0, comment: '' },
          { question: 'Are repeated conditionals avoided?', score: 0, comment: '' },
          { question: 'Are nested conditionals avoided?', score: 0, comment: '' },
          { question: 'Are lots of loops avoided?', score: 0, comment: '' },
          { question: 'Are nested loops avoided?', score: 0, comment: '' },
          { question: 'Are large components avoided?', score: 0, comment: '' },
      ...
      },
      {
        title: 'Documentation',
        questions: [
          { question: 'Is the code self-documenting?', score: 0, comment: '' },
      ...
      },
      {
        ...
        questions: [
          { question: 'Are secrets in the repository avoided?', score: 0, comment: '' },
          { question: 'Is broken access control avoided?', score: 0, comment: '' },
          { question: 'Are cryptographic failures avoided?', score: 0, comment: '' },
          { question: 'Is the possibility of injection avoided?', score: 0, comment: '' },
          { question: 'Is insecure design avoided?', score: 0, comment: '' },
          { question: 'Is security misconfiguration avoided?', score: 0, comment: '' },
          { question: 'Are vulnerable and outdated components avoided?', score: 0, comment: '' },
    ...
    topics: [
      {
        ...
        questions: [
          { question: 'Are unit tests present?', score: 0, comment: '' },
          { question: 'Is code split up in pure functions to easily test?', score: 0, comment: '' },
          { question: 'Is the coverage threshold met? >80%, less than 100%', score: 0, comment: '' },
          { question: 'Are unit tests meaningful?', score: 0, comment: '' },
          { question: 'Are unit tests isolated?', score: 0, comment: '' },
          { question: 'Are externals mocked correctly?', score: 0, comment: '' },
          { question: 'Are components mounted correctly?', score: 0, comment: '' },
      ...
      },
      {
        ...
        questions: [
          { question: 'Are functional tests present?', score: 0, comment: '' },
