...
<template>
  <div class="mt-16 md:mt-0">
    <h2 class="text-4xl lg:text-5xl font-bold lg:tracking-tight">Everything you need to review a project</h2>
    <p class="text-lg mt-4 text-slate-600">
      Use the template to guide you through your code review. This way we have an uniform way of making our reports and testing our applications.
    </p>
  </div>
