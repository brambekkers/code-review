...
<template>
  <OverlayBadge severity="danger">
    <Button class="text-contrast" severity="contrast" label="Team info" @click="visible = !visible">
      ...
      <Dialog v-model:visible="visible" modal class="w-[95%] md:!w-5/6 max-w-[1000px] pb-6" header="Team information">
        ...
        <div class="flex w-full gap-2">
          ...
          <Button label="Add reviewer" severity="contrast" @click="addReviewer()" />
        </div>
        ...
        <div v-else class="flex gap-2 mt-2">
          <OverlayBadge v-for="reviewer of reviewers" severity="danger">
